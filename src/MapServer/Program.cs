...
//
// File: src/MapServer/Program.cs
// Purpose: Contains program code for the map server runtime, world-map ownership, and grid/tile coordination.
...
try
{
    ...
    Logger.WriteBanner("Map Server");

    RuntimeConcurrencyConfigurator.ConfigureForServer("MapServer");
...
{
    Logger.Write(LogType.INFORMATION, "Shutdown requested. Stopping MapServer...", "Program");
}
