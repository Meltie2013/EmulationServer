...
//
// File: src/RealmServer/Program.cs
// Purpose: Contains program code for the realm server authentication, realm-list, and account connection layer.
...
{
    Logger.Write(LogType.INFORMATION, "Shutdown requested. Stopping RealmServer...", "Program");
}
