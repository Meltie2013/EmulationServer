...
/**
  * Defines the allowed map grid loading mode values used to keep state and protocol decisions explicit.
  * The type keeps related data and behavior together so the rest of the project can depend on a clear responsibility boundary.
  */
public enum MapGridLoadingMode
{
    /**
      * Represents the on demand value for MapGridLoadingMode.
      */
    OnDemand,
    /**
      * Represents the preload value for MapGridLoadingMode.
      */
    Preload,
}
