...
//
// File: src/EmulationServer.Game/WorldData/CreatureAreaEnrichmentResult.cs
// Purpose: Contains creature area enrichment result code for the game-domain data, player state, DBC, and world-template layer.
// Documentation: Uses normal line comments so the source stays readable without C# XML documentation tags.

namespace EmulationServer.Game.WorldData;

// Type: CreatureAreaEnrichmentResult
// Purpose: Represents creature area enrichment result data passed through the game-domain data, player state, DBC, and world-template layer.
// Constructor values:
...
public sealed record CreatureAreaEnrichmentResult(
