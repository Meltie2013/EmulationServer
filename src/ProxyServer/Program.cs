...
/**
 * File overview: src/ProxyServer/Program.cs
 * Documents the Program source file for the proxy server entry point.
...
try
{
    ...
    Logger.Write(LogType.NOTICE, @"                          :: Proxy Server ::");
...
{
    Logger.Write(LogType.INFORMATION, "Shutdown requested. Stopping ProxyServer...", nameof(Program));
}
