...
/**
 * File overview: tools/EmulationServer.Tools.Extraction/Extraction/KnownDbcFiles.cs
 * Documents the KnownDbcFiles source file in the client data extraction and conversion tooling area of the Emulation Server project.
...
/**
 * Owns the known dbc files behavior for the client data extraction and conversion tooling layer.
 * The class keeps related validation, state changes, and external calls in one place so startup, runtime handling, and shutdown remain predictable.
 */
public static class KnownDbcFiles
{
    /**
      * Gets or stores the all value used by KnownDbcFiles.
