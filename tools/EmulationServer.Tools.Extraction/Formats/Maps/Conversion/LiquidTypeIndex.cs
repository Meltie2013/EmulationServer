...
/**
  * Represents the liquid type index component in the developer tooling for data extraction, validation, and diagnostics area.
...
public sealed class LiquidTypeIndex
{
    ...
    /**
      * Creates a new LiquidTypeIndex instance and stores the dependencies required by the component.
