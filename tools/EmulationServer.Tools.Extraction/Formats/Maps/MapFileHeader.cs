...
/**
 * File overview: tools/EmulationServer.Tools.Extraction/Formats/Maps/MapFileHeader.cs
 * Documents the MapFileHeader source file in the client data extraction and conversion tooling area of the Emulation Server project.
